...
CREATE TABLE IF NOT EXISTS `cozinha-api`.`pedido_item_menu` (
  ...
  PRIMARY KEY (`id`),
  INDEX `pedido_item_menu_idx` (`id_item_menu` ASC),
  INDEX `pedido_item_menu_pedido_idx` (`id_pedido` ASC),
...
CREATE TABLE IF NOT EXISTS `cozinha-api`.`item_menu_ingrediente` (
  ...
  PRIMARY KEY (`id`),
  INDEX `item_menu_ingrediente_item_menu_idx` (`item_menu_id` ASC),
  INDEX `item_menu_ingrediente_ingrediente_idx` (`ingrediente_id` ASC),
